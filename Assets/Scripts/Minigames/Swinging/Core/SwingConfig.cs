namespace VineSwinging.Core {
    public readonly struct SwingConfig {
        ...
        public readonly float AttractionReferenceDistance;
        ...
        public SwingConfig(float amplitude, float ropeLength, float period, float launchForce, float grabRadius,
            ...
            float attractionReferenceDistance, float maxSpeedMultiplier, float maxPhaseAdjustment) {
            Amplitude = amplitude;
            ...
            AttractionReferenceDistance = attractionReferenceDistance;
